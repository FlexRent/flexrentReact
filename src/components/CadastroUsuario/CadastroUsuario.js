  ...
  return (
    ...
    <Header/>
      ...
      <div className="d-flex justify-content-center align-items-center vh-100 row">
        <div className='col-12 col-lg-6 d-flex justify-content-center align-items-start' style={{ width: '40%', height: '50vh' }}> 
          <img src="../assets/dadosPessoais.png" className=" ms-5" style={{ height: '100%' }} />
        </div>
        


        <div className="col-12 col-lg-6 d-flex flex-column justify-content-center align-items-center" >
          <div className="border rounded-top" style={{ width: '90%', backgroundColor: '#4BBE8F' }} >
            <h4 className=" ms-3 my-3 text-white" >Dados pessoais</h4>
          </div>
          <Form className="border rounded-bottom p-4" style={{ height: '45vh', width: '90%' }}>
            <Row>
              <Col sm={6}>
            ...
            <div className="d-flex justify-content-between my-5">
              <div className="ms-auto">
                <Button className='px-5'style={{ backgroundColor: '#4BBE8F', border: 'none' }}>Continuar</Button>
              </div>
            </div>
          </Form>
        </div>
