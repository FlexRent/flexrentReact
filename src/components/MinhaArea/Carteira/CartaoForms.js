            ...
            <div className='forms-content'>
                ...
                <form className="row">
                    <div className="col-12 ">
                        ...
                        <input type="text" className="form-control form-control-sm custom-border" id="titulo-cartao"  />

                        <label htmlFor="inputEmail4" className="form-label ">Nome impresso</label>
                        <input type="text" className="form-control form-control-sm custom-border" id="nome-cartao" onChange={handleInputChange} value={text}/>

                        <label htmlFor="inputEmail4" className="form-label">Numero do cartão</label>
                        <ReactInputMask className="form-control form-control-sm custom-border input-number-custom" id="numero-cartao" mask={"9999  9999  9999  9999"} />
                        {/* <input type="number" className="form-control form-control-sm custom-border input-number-custom" id="numero-cartao" /> */}
                    </div>

                    <div className="col-5">
                        <label htmlFor="validade-cartao" className="form-label">Validade</label>
                        <ReactInputMask className="form-control form-control-sm custom-border" id="validade-cartao" mask={"99 / 99"}/>
                    ...
                    <div className="col-5">
                        <label htmlFor="cvv-cartao" className="form-label">CVV</label>
