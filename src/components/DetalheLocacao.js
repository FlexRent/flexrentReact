import { Image, Row, Col, Button, Navbar, Container } from 'react-bootstrap';
  ...
  return (
    <>
      ...
      <Row className="justify-content-center align-items-center vh-100">
        ...
        <Col md={5} className='bordaDetalheLocacao mx-1 mb-3'>
          <h3 className=' textonomeproduto text-center mb-5 mt-3'>Nome do Produto</h3>
        ...
        <Col md={3} className='backgroundlocacao p-1 mb-3'>
          <div className='px-3'>
            <h4 className='textoinformacoes pb-4 text-center text-white'>Informações</h4>
