      ...
      <Container fluid className="vh-100 align-items-center justify-content-center" >
        ...
        <div className=" row justify-content-center ">
          <Col md={6} className=" d-flex justify-content-end my-2">
            <div className="border border-dark rounded-start p-3 d-flex justify-content-center align-items-center" style={{ width: '500px', height: '350px' }}>
              {productImage && (
                <img src={productImage} alt="Imagem do produto" className="img-fluid" />
              )}
            </div>
          </Col>
          <Col md={6} className=" d-flex justify-content-start my-2">
            <div className="border border-primary rounded-end p-3" style={{ width: '500px'}}>
              <p>
                ...
                <strong>Localização:</strong> {productLocation}<br />
                <h5 className='mb-3'>Santo Amaro</h5>
                <strong className='me-2'>Período:</strong> 
                <select className='mb-4' value={rentalPeriod} onChange={handleRentalPeriodChange}>
                ...
                <br />
                <hr></hr>
                <strong>Total:</strong> {rentalPrice}<br />
              </p>
              <div className="d-flex justify-content-end ">
              <Button variant="primary" onClick={handleRentButtonClick} className='w-50 '  style={{ backgroundColor: '#16697A' }}>Alugar</Button>
            </div>
            </div>
          </Col>
        </div>
