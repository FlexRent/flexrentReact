...
import '../../Css/carrinho/CarrinhoFinal.css'
    ...
    <>
      ...
      <Container>
        ...
        <Row className="d-flex justify-content-center align-items-center vh-100">
          ...
          <div id='borda' className="p-3 d-flex" style={{ width: '80%', height: '40%' }}>
            <Row>
              <Row >
                <Col>
                  <h3 className=" textoProduto text-center mb-1">Nome do Produto</h3>
                </Col>
              ...
              <Col xs={10} md={5}  >
                <div className=" ajustealtura flex-column d-flex align-items-center justify-content-center mx-5">
                  <p className='text-center'>Total: R$X</p>
                  <Button type="submit" className=" mt-3  botaocarrinhofinal">
                    Concluir
                  </Button>
                </div>
              </Col>
